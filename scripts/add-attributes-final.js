    ...
    for (const collection of collections) {
        ...
        for (const attr of collection.attributes) {
            try {
                if (attr.type === 'string') {
                    if (attr.required) {
                        // Required string attributes cannot have default values
                        ...
                        // Optional string attributes can have default values
                        await databases.createStringAttribute(
                            DATABASE_ID,
                            collection.id,
                            attr.key,
                    ...
                    if (attr.required) {
                        // Required integer attributes cannot have default values
                        ...
                        // Optional integer attributes can have default values
                        await databases.createIntegerAttribute(
                            DATABASE_ID,
                            collection.id,
                            attr.key,
                    ...
                    if (attr.required) {
                        // Required boolean attributes cannot have default values
                        ...
                        // Optional boolean attributes can have default values
                        await databases.createBooleanAttribute(
                            DATABASE_ID,
                            collection.id,
                            attr.key,
                    ...
                    // Datetime attributes cannot have default values
