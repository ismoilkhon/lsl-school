        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            <div className="relative">
              <div
                className="w-full h-96 bg-gradient-to-br from-blue-400 to-purple-600 rounded-2xl shadow-2xl flex items-center justify-center"
              >
          ...
          >
            ...
            <Typography
              variant="h3"
              className="text-3xl font-bold text-blue-900 mb-4 mt-8"
              placeholder=""
              onPointerEnterCapture={() => {}}
              onPointerLeaveCapture={() => {}}
            >
